...
class _$NetworkExceptionsTearOff {
  ...
  Forbidden forbidden({String? reason}) {
    return Forbidden(
      reason: reason,
    );
  }

  BadRequest badRequest({String? reason}) {
    return BadRequest(
      reason: reason,
    );
  }
...
abstract class Forbidden implements NetworkExceptions {
  const factory Forbidden({String? reason}) = _$Forbidden;
...
class _$BadRequest implements BadRequest {
  const _$BadRequest({this.reason});
...
abstract class BadRequest implements NetworkExceptions {
  const factory BadRequest({String? reason}) = _$BadRequest;
