...
class MaterialText extends StatelessWidget {
  ...
  const factory MaterialText.title(String text,
      {Key key,
      TextStyle style,
      TextAlign textAlign,
      bool softWrap,
      ...
      ui.TextHeightBehavior textHeightBehavior,
      double textScaleFactor,
      TextWidthBasis textWidthBasis}) = _Title;
...
class _Title extends MaterialText {
  const _Title(String text,
      {Key? key,
      TextStyle? style,
      TextAlign? textAlign,
      bool? softWrap,
  ...
  @override
  Widget build(BuildContext context) {
    final overLine = Theme.of(context).textTheme.titleMedium;
    return Text(
      text!,
      style: style != null ? overLine!.merge(style) : overLine,
      textDirection: textDirection,
