...
import 'package:driver/features/support/presentation/manager/support/container.dart';
import 'package:driver/features/support/presentation/manager/support/event.dart';
...
import '../../../../common/widgets/src/material_text.dart';
import '../../../../generated/assets.dart';
import '../manager/support/bloc.dart';
                    ...
                    Center(
                      ...
                      onPressed: () async {
                        if (_reportController.text.isNotEmpty) {
                          context.read<SupportBloc>().add(PostSupportEvent(_reportController.text));
                        } else {
