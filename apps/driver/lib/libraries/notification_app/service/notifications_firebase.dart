import 'package:driver/common/utils/logs.dart';
import 'package:driver/libraries/notification_app/util/strings.dart';
import 'package:driver/libraries/notification_app/widgets/notification_dialog_function.dart';
...
class FirebaseNotification {
  ...
  Future<void> setUpFirebase() async {
    ...
    await FirebaseMessaging.instance.getToken().then((value) {
      firebaseToken = value ?? "";
      Logs.logger.i("firebaseToken:      $value");
  ...
  Future<dynamic> onMessage(RemoteMessage message) async {
    ...
    if (notification != null && android != null) {
      ...
      if (body != null && title != null) {
        Logs.logger.i("onMessage");
        switch (displayType) {
          case DisplayType.dialog:
            {
              notificationDialog(
                  title: title, subTitle: body, context: context);
            }
            break;
