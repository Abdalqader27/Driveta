...
late GoogleMapController controllerRecord;

class MapStoreRecordDetails extends StatefulWidget {
  final DeliversProduct delivers;

  const MapStoreRecordDetails({Key? key, required this.delivers})
      : super(key: key);

  @override
  State<MapStoreRecordDetails> createState() => _MapStoreRecordDetailsState();
}

class _MapStoreRecordDetailsState extends State<MapStoreRecordDetails> {
                  ...
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(DateFormat('yyyy-MM-dd – hh:mm').format(
                          DateTime.parse(
                              widget.delivers.startDate.toString()))),
                              ...
                              Expanded(
                                child: ListTile(
                                  ...
                                  leading: const CircleAvatar(
                                      backgroundColor: kGrey2,
                                      child:
                                          Center(child: Icon(Icons.numbers))),
                                ),
                              ),
                            ],
                          ),
  ...
  Future<void> getPlaceDirection(
    ...
    await setMapFitToTour(polyLineSet, controllerRecord);
